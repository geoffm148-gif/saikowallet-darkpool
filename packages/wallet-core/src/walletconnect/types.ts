...
export const SUPPORTED_METHODS = [
  'personal_sign',
  // eth_sign intentionally excluded — allows signing arbitrary hashes without prefix,
  // enabling transaction forgery. Disabled by default (per MetaMask 2023 policy).
  'eth_signTypedData',
