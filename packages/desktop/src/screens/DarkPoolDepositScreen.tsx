...
export function DarkPoolDepositScreen(): React.ReactElement {
  ...
  async function handleConfirm(): Promise<void> {
    ...
    try {
      ...
      // 2. Deposit into DarkPool V3 (commitment, amount, claimKeyHash)
      setDepositStatus('Sending deposit tx...');
      const claimKeyHash = ethers.keccak256(ethers.solidityPacked(['bytes32'], [
      ...
      const depositHash = await sendSignedTx(hdWallet, {
        ...
        data: darkPoolIface.encodeFunctionData('deposit', [commitment, tierAmountWei, claimKeyHash]),
        value: 0n,
        nonce: currentNonce,
        gasLimit: 1_200_000n,
        ...gasParams,
